# GOFIGURE2 Common Dashboard Script
#
...
#   dashboard_source_name     = Name of source directory (GOFIGURE2)
#   dashboard_binary_name     = Name of binary directory (GOFIGURE2-build)
...
set(dashboard_git_url "git://github.com/gofigure2/GoFigure2.git")
endif()
...
if(EXISTS ${CTEST_SOURCE_DIRECTORY})
  ...
  if(vcs_refresh AND "${CTEST_SOURCE_DIRECTORY}" MATCHES "/(GOFIGURE2|gofigure2|GoFigure2)[^/]*")
